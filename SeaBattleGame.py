...
class SeaBattleGame:
    ...
    def get_position(self, auto=False) -> tuple:
        while True:
            try:
                if auto:
                    coords = range(10)
    ...
    def get_direction(self, auto=False) -> str:
    ...
    def ship_placement_manually(self) -> None:
    ...
    def ship_placement_automatically(self, player: Player) -> None:
        ships_remained = [1, 1, 1, 1, 2, 2, 2, 3, 3, 4]
        while ships_remained:
...
|=|___________|=|--------------------------------------------------------------------------------------------------"""))
    ...
    def game_round(self, player: Player) -> None:
    ...
    def end_game(self):
        if self._computer.board.ships_count() == 20:
            print("""================================================================================================================
